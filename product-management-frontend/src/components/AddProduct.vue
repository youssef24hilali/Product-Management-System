<template>
  <div class="container">
    <div class="signup-content">
      <form @submit.prevent="addProduct" method="post" class="signup-form">
        ...
        <div class="form-group">
          <input type="submit" name="submit" id="submit" class="btn btn-primary send-button" value="Add Product"/>
        </div>
      </form>
    </div>
  </div>
