<template>
  <aside class="sidebar">
    ...
    <div class="side-inner">
      ...
      <div class="profile">
        <img src="../../public/assets/images/profile.jpg" alt="Image" class="img-fluid">
        <h3 class="name">Product Management</h3>
        <span class="country">System</span>
      </div>


      <div class="nav-menu">
        <ul>
          <li><router-link to="/"><span class="icon-home mr-3"></span>Home</router-link></li>
          <li class="accordion">
            <router-link data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsible" to="/categories">
              <span class="mr-3"><i class="fa-solid fa-box-open"></i></span>Categories
            </router-link>
            <div id="collapseOne" class="collapse" aria-labelledby="headingOne">
              <div>
                <ul>
                  <li><router-link to="/categories"><span class="mr-3"><i class="fa-sharp fa-solid fa-list"></i></span>List</router-link></li>
                  <li><router-link to="/addCategory"><span class="mr-3"><i class="fa-solid fa-circle-plus"></i></span>Add</router-link></li>
                </ul>
              </div>
            </div>
          </li>
          <li class="accordion">
            <router-link to="/products" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsible">
              <span class="mr-3"><i class="fa-solid fa-basket-shopping"></i></span>Products
            </router-link>

            <div id="collapseTwo" class="collapse" aria-labelledby="headingOne">
              <div>
                <ul>
                  <li><router-link to="/products"><span class="mr-3"><i class="fa-sharp fa-solid fa-list"></i></span>List</router-link></li>
                  <li><router-link to="/addProduct"><span class="mr-3"><i class="fa-solid fa-circle-plus"></i></span>Add</router-link></li>
                </ul>
              </div>
            </div>
